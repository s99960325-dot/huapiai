...
from huapir.events.plugin import PluginLoaded, PluginStarted, PluginStopped
...
from huapir.plugin_manager.models import PluginInfo
from huapir.plugin_manager.plugin import Plugin
from huapir.plugin_manager.plugin_event_bus import PluginEventBus
        ...
        try:
            ...
            if possible_plugin_infos:
                if possible_plugin_infos[0].version != old_version:
                    ...
                    raise Exception(
                        f"Failed to update plugin: {plugin_info.package_name} is already up to date for current Huapir version. Maybe you should update Huapir to the latest version."
                    )
