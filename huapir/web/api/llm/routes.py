...
from huapir.llm.adapter import AutoDetectModelsProtocol
...
from huapir.web.api.llm.models import (LLMAdapterConfigSchema, LLMAdapterTypes, LLMBackendCreateRequest,
